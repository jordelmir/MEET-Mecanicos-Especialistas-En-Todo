...
- Queda una ruta antigua de aceptación optimista y escritura directa en `acceptRideOffer`; requiere convergencia posterior a un único comando autoritativo y pruebas con dos cuentas. No debe usarse para declarar la aceptación de ofertas verificada.
