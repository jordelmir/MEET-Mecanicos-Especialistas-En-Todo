...
BEGIN
  ...
  LOOP
    IF COALESCE(v_event->>'actor_id', v_actor_text) <> v_actor_text THEN
      RAISE EXCEPTION 'Event actor does not match authenticated profile';
    END IF;
    ...
    VALUES (
      ...
      v_event->>'event_type',
      COALESCE(v_event->>'actor_id', v_actor_text),
      v_event->>'actor_role',
