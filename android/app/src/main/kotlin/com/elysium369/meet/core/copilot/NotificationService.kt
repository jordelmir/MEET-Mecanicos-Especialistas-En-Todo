...
class NotificationService @Inject constructor(
    ...
    fun startListeningToEvents() {
        if (job != null) return
        Log.i("NotificationService", "Starting Elysium Vanguard AI OS Copilot NotificationService...")
        job = scope.launch {
    ...
    fun stopListeningToEvents() {
        job?.cancel()
        job = null
        Log.i("NotificationService", "Stopped Elysium Vanguard AI OS Copilot NotificationService.")
    }
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name = "Elysium Vanguard AI OS Copilot Alerts"
