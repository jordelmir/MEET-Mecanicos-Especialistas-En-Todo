...
class GeminiDiagnostic(
    ...
    suspend fun analyzeDtc(
        ...
        return withContext(Dispatchers.IO) {
            ...
            val prompt = """
                ...
                ---
                **IMPORTANTE:** Al final de tu respuesta, DEBES incluir un bloque JSON con este formato exacto para que el sistema Elysium Vanguard AI OS pueda procesar los datos:
                ```json
                {
    ...
    suspend fun chat(
        ...
        return withContext(Dispatchers.IO) {
            ...
            val systemPrompt = """
                Eres el Sistema de Asistencia Elysium Vanguard AI OS (Motor de Diagnóstico Inteligente).
                ...
                5. Eres parte del ecosistema Elysium Vanguard AI OS, por lo que conoces las funciones de la app (Scanner, DTCs, Topología, Pruebas Activas).
            ...
            try {
                ...
                if (useOpenAi || useAnthropic) {
                    ...
                    if (history.isEmpty()) {
                        ...
                        contents.put(JSONObject().apply {
                            put("role", "model")
                            put("parts", JSONArray().put(JSONObject().put("text", "Entendido. Soy el asistente Elysium Vanguard AI OS. ¿En qué puedo ayudarte con el $vehicleInfo hoy?")))
                        })
                        history.forEach { msg ->
                            contents.put(JSONObject().apply {
    ...
    suspend fun analyzeActiveTest(
        ...
        return withContext(Dispatchers.IO) {
            ...
            val prompt = """
                ...
                Eres un Especialista de Diagnóstico Master L1 (ASE) de la división Elysium Vanguard AI OS.
