...
object GenericInlineFourAssetContract {
    ...
    val bindings: List<GenericEngineAssetBinding> = listOf(
        ...
        binding(
            ...
            3.6f,
            0f,
            "Tu motor 1.6 es gasolina y utiliza bujías de chispa. No equipa glow plugs"
        ),
        binding("ignition_coils", 1, 0f, 3.9f, 0.4f, "Paquete de bobinas"),
        binding("ignition_harness", 1, 0f, 4.1f, -0.7f, "Arnés de bobinas", "Cables de bujía"),
        ...
        binding("fuel_rail", 1, 0f, 2.7f, -2.5f, "Riel de inyectores"),
        binding("fuel_injectors", 2, 0f, 2.2f, -2.2f, "Inyectores"),
        binding("injector_o_rings", 1, 0f, 2.45f, -2.35f, "O-rings de inyectores"),
        binding("injector_clips", 1, 0f, 2.8f, -2.2f, "Clips de inyectores"),
        binding("injector_harness", 1, 0f, 3.15f, -2.6f, "Arnés de inyectores"),
        binding("fuel_lines", 1, -2.8f, 1.2f, -2.3f, "Líneas de combustible"),
        binding("alternator", 1, 2.9f, 0.2f, -2.4f, "Alternador"),
        binding("alternator_pulley", 1, 3.2f, 0.2f, -2.4f, "Polea de alternador"),
        binding("starter_motor", 1, -2.9f, -1.25f, -2f, "Motor de arranque"),
        binding("starter_solenoid", 1, -2.7f, -0.75f, -2f, "Solenoide de arranque"),
        binding("accessory_tensioner", 1, 3.2f, 1.1f, -1f),
        binding("pcv_valve", 1, -1.2f, 3.8f, -0.8f, "Válvula PCV"),
        binding("pcv_hose", 1, -1.6f, 3.4f, -1.8f, "Manguera PCV"),
        binding("vacuum_hoses", 1, 1.4f, 2.8f, -2.4f, "Mangueras de vacío"),
        binding("coolant_hoses", 1, -3.1f, 1.5f, 2.2f, "Manguera superior de radiador", "Mangueras bypass"),
        binding("ckp_sensor", 1, 2.8f, -0.5f, 0.8f, "Sensor CKP cigüeñal", "Sensor CKP del cigüeñal"),
        binding("cmp_sensor", 1, 2.7f, 3.2f, -0.8f, "Sensor CMP árbol de levas", "Sensor CMP del árbol de levas"),
        binding("map_sensor", 1, 1.2f, 2.2f, -3f, "Sensor MAP"),
        binding("ect_sensor", 1, -2.4f, 1.8f, 2.1f, "Sensor de temperatura de refrigerante ECT"),
        binding("knock_sensor", 1, 0.6f, 0.8f, 2f, "Knock sensor / sensor de detonación"),
        binding("oil_pressure_sensor", 1, -1.8f, -0.4f, -2f, "Sensor presión de aceite", "Sensor de presión de aceite"),
