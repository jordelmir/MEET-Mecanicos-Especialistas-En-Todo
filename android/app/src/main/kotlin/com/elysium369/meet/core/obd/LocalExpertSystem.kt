        ...
        private val dtcTrie = DtcTrie().apply {
            ...
            insert("P0505", DtcRule(
                ...
                testSteps = listOf(
                    ...
                    "3. Prueba de Actuador: Use las pruebas bidireccionales de Elysium Vanguard AI OS para forzar la apertura y cierre de la IAC y observe el cambio en las RPM.",
            ...
            insert("P0700", DtcRule(
                ...
                testSteps = listOf(
                    "1. Leer Códigos de la TCM: Ingrese al módulo de la transmisión (TCM) utilizando el escáner Elysium Vanguard AI OS para leer los códigos específicos (ej: P0730, P0750). El código P0700 solo indica que el motor encendió la luz MIL a petición de la transmisión.",
