            ...
            TopAppBar(
                title = {
                    Column {
                        ...
                        Text("Casos documentados y su evolución", fontSize = 11.sp, color = MeetColors.cyberCyan)
                    }
                },
                navigationIcon = {
            ...
            item {
                Card(
                    ...
                    Column(modifier = Modifier.padding(16.dp)) {
                        Text("PRÓXIMAMENTE", style = MaterialTheme.typography.labelSmall, fontWeight = FontWeight.Bold, color = MeetColors.textSecondary, letterSpacing = 1.2.sp)
